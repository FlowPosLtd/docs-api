      ...
      },
      {
        ...
        bodyParams: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "Addon/modifier data for this item as a JSON object with an `addons` array. Each addon has `extension_id` and `quantity`.",
            example: '{"addons":[{"extension_id":1,"quantity":1}]}',
          },
          {
            name: "note",
            type: "string",
