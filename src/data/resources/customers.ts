...
export const customerResources: Resource[] = [
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "number",
        required: false,
        description: "Lifetime total spend by this customer.",
      },
      {
        name: "orders_count",
        type: "integer",
      ...
      },
      {
        ...
        type: "integer",
        required: false,
        description: "ID of the tenant this customer belongs to.",
      },
      {
        name: "created_at",
        type: "timestamp",
        required: false,
        description: "Time the customer record was created.",
      },
      {
        name: "updated_at",
        type: "timestamp",
        required: false,
        description: "Time the customer record was last modified.",
      },
    ],
    endpoints: [
      {
...

  {
    ...
    attributes: [
      {
        ...
        type: "integer",
        required: false,
        description: "Unique numeric identifier for the customer group.",
      },
      {
        name: "name",
        type: "string",
      ...
      },
      {
        ...
        required: false,
        description:
          "Hex colour code used to label the group in the dashboard (e.g. `#FFD700`).",
      },
      {
        name: "customers_count",
        type: "integer",
        required: false,
        description: "Number of customers currently in this group.",
      },
      {
        name: "customers",
        type: "object[]",
        required: false,
        description:
          "Array of customer objects in this group. Only included on retrieve endpoints.",
      },
      {
        name: "created_at",
        type: "timestamp",
    ...
    endpoints: [
      ...
      },
      {
        ...
        responseDescription:
          "Returns the updated group with its assigned customers.",
      },
    ],
  },
];
